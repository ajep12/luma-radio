    ...
    <>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        <SectionHeading
          ...
          action={
            <Link to="/schedule" className="text-sm font-medium text-lime hover:underline">
              Full schedule →
            </Link>
          }
        />
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        <SectionHeading
          ...
          action={
            <Link to="/shows" className="text-sm font-medium text-lime hover:underline">
              All shows →
            </Link>
          }
        />
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        <SectionHeading
          ...
          action={
            <Link to="/presenters" className="text-sm font-medium text-lime hover:underline">
              All presenters →
            </Link>
          }
        />
